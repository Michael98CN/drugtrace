...
public class FabricManagerTest {
    ...
    private final static String channelName = "hmqchannel";
    ...
    private FabricConfig getConfig(Integer type) {
        ...
        if (type==1){
            config.setChaincode(getChaincode(channelName, "register"
                    , "github.com/hyperledger/fabric/aberic/chaincode/go/register/", version));
        }else {
            config.setChaincode(getChaincode(channelName, "drugtrace1"
                    , "github.com/hyperledger/fabric/aberic/chaincode/go/drugtrace1/", version));
        }
        //加载通道配置文件
...
//        orderer.addOrderer("orderer2.example.com", "grpc://x.x.x.xxx:7050");
    ...
    private Peers getPeers() {
        ...
        peers.addPeer("peer0.org1.example.com", "peer1.org1.example.com",
                "grpc://39.108.86.64:7051", "grpc://39.108.86.64:7051", "http://39.108.86.64:7054");
        return peers;
    }
